...
<template>
  <section v-if="kind === 'embedding'" class="concept-explainer" aria-label="임베딩 개념 설명">
    ...
    <details class="concept-expansion"><summary>예시와 자세한 설명 펼치기</summary>
  ...
  <section v-else-if="kind === 'ffn'" class="concept-explainer" aria-label="피드포워드 개념 설명">
    ...
    <details class="concept-details">
      ...
      <p>각 숫자를 ‘기쁨 점수’, ‘정답 점수’처럼 하나의 이름으로 읽지는 않습니다. 여러 숫자가 함께 정보를 표현합니다. ‘계산 연결 모형’은 FFN 출력으로 후보 점수까지 계산합니다. ‘문장 예시’나 Gemini 후보 방식은 별도 후보를 사용합니다.</p>
    </details>
    </details>
  </section>
</template>
...
.concept-expansion > summary { cursor: pointer; color: #12657a; padding: 8px 0; font-size: .9375rem; font-weight: 800; }
.concept-expansion > summary:focus-visible { outline: 3px solid #12657a; outline-offset: 3px; }
